...
namespace NzbDrone.Core.Notifications.Trakt
{
    ...
    public class TraktProxy : ITraktProxy
    {
        ...
        private const string RedirectUri = "https://auth.servarr.com/v1/trakt_whisparr/auth";
        private const string RenewUri = "https://auth.servarr.com/v1/trakt_whisparr/renew";
