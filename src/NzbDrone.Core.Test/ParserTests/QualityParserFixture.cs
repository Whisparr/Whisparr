...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class QualityParserFixture : CoreTest
    {
        ...
        [TestCase("Series.Polo.S01E11.One.Hundred.Whisparrs.2015.German.DD51.DL.720p.NetflixUHD.x264.NewUp.by.Wunschtante", false)]
        [TestCase("Series 2016 German DD51 DL 720p NetflixHD x264-TVS", false)]
        [TestCase("Series.6x10.Basic.Whisparr.Repair.and.Replace.ITA.ENG.720p.WEB-DLMux.H.264-GiuseppeTnT", false)]
        ...
        [TestCase("Series.S01E01.The.Whisparr.Principle.720p.WEB-DL.DD5.1.H.264-BD", false)]
        ...
        [TestCase("Its.Always.Whisparrs.Fault.S08E01.1080p.WEB-DL.proper.AAC2.0.H.264", true)]
        ...
        [TestCase("The.Big.Easter.Theory.S06E11.The.Whisparr.Simulation.1080p.WEB-DL.DD5.1.H.264", false)]
        [TestCase("Whisparr's.Baby.S01E02.Night.2.[WEBDL-1080p].mkv", false)]
        ...
        [TestCase("House.of.Whisparr.AK.s05e13.4K.UHD.WEB.DL", false)]
        [TestCase("House.of.Whisparr.AK.s05e13.UHD.4K.WEB.DL", false)]
        ...
        [TestCase("JUST ADD WHISPARR S01E01.2160P AMZN WEBRIP DD2.0 X264-TROLLUHD", false)]
        [TestCase("The.Man.In.The.Series.S01E01.2160p.AMZN.WEBRip.DD2.0.Hi10p.X264-TrollUHD", false)]
        [TestCase("The Man In the Series S01E01 2160p AMZN WEBRip DD2.0 Hi10P x264-TrollUHD", false)]
        [TestCase("House.of.Whisparr.AK.S05E08.Chapter.60.2160p.NF.WEBRip.DD5.1.x264-NTb.NLsubs", false)]
        [TestCase("Whisparr Saves the World S01 2160p Netflix WEBRip DD5.1 x264-TrollUHD", false)]
        ...
        [TestCase("The Big Series.S03E01.The Whisparr Can Opener.m2ts", false)]
        [TestCase("Series.S01E02.Chained.Whisparr.[Bluray720p].mkv", false)]
        [TestCase("[FFF] DATE A Whisparr Dev - 01 [BD][720p-AAC][0601BED4]", false)]
        ...
        [TestCase("Whisparr.Of.Series.S02E13.1080p.BluRay.x264-AVCDVD", false)]
        ...
        [TestCase("[Zurako] Log Series - 01 - The Whisparr (BD 1080p AAC) [7AE12174].mkv", false)]
        ...
        [TestCase("How I Met Your Developer S01E18 Nothing Good Happens After Whisparr 720p HDTV DD5.1 MPEG2-TrollHD", false)]
