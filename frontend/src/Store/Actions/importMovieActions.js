...
export const LOOKUP_UNSEARCHED_MOVIE = 'importMovie/lookupUnsearchedMovie';
...
export const lookupUnsearchedMovie = createThunk(LOOKUP_UNSEARCHED_MOVIE);
...
export const actionHandlers = handleThunks({
  ...
  [LOOKUP_UNSEARCHED_MOVIE]: function(getState, payload, dispatch) {
    const state = getState().importMovie;
  ...
  [IMPORT_MOVIE]: function(getState, payload, dispatch) {
    ...
    const promise = createAjaxRequest({
      ...
      data: JSON.stringify(allNewMovie)
    }).request;
    ...
    promise.done((data) => {
      dispatch(batchActions([
        ...
        ...data.map((movie) => updateItem({ section: 'movie', ...movie })),
