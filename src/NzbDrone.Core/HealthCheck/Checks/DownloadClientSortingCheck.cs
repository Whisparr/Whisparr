                ...
                try
                {
                    ...
                    if (status.SortingMode.IsNotNullOrWhiteSpace())
                    {
                        return new HealthCheck(GetType(),
                            ...
                            $"Download client {clientName} has {status.SortingMode} sorting enabled for Whisparr's category. You should disable sorting in your download client to avoid import issues.",
