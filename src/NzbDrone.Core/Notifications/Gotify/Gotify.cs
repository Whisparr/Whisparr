...
namespace NzbDrone.Core.Notifications.Gotify
{
    ...
    {
        private const string WhisparrImageUrl = "https://raw.githubusercontent.com/Whisparr/Whisparr/eros/Logo/128.png";
        ...
        public override ValidationResult Test()
        {
            ...
            try
            {
                ...
                if (Settings.MetadataLinks.Any())
                {
                    ...
                    sb.AppendLine("");
                    sb.AppendLine("[Whisparr.com](https://whisparr.com)");
