...
import styles from './EditSceneModalContent.css';

class EditSceneModalContent extends Component {
...
EditSceneModalContent.propTypes = {
  ...
  onDeleteScenePress: PropTypes.func.isRequired
};

export default EditSceneModalContent;
