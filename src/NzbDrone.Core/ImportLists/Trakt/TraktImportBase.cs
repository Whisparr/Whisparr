...
namespace NzbDrone.Core.ImportLists.Trakt
{
    ...
    where TSettings : TraktSettingsBase<TSettings>, new()
    {
        ...
        public const string RedirectUri = "https://auth.servarr.com/v1/trakt_whisparr/auth";
        public const string RenewUri = "https://auth.servarr.com/v1/trakt_whisparr/renew";
