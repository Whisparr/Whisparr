...
function OrganizeSeriesModalContent(props: OrganizeSeriesModalContentProps) {
  ...
  return (
    <ModalContent onModalClose={onModalClose}>
      <ModalHeader>{translate('OrganizeSelectedSitesModalHeader')}</ModalHeader>

      <ModalBody>
        <Alert>
          {translate('OrganizeSelectedSitesModalAlert')}
          <Icon className={styles.renameIcon} name={icons.ORGANIZE} />
        </Alert>

        <div className={styles.message}>
          {translate('OrganizeSelectedSitesModalConfirmation', {
