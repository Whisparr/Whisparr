...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class IndexerSearchCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, "No indexers available with Automatic Search enabled, Whisparr will not provide any automatic search results", "#no-indexers-available-with-automatic-search-enabled-whisparr-will-not-provide-any-automatic-search-results");
            }
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, "No indexers available with Interactive Search enabled, Whisparr will not provide any interactive search results", "#no-indexers-available-with-interactive-search-enabled");
            }
