...
namespace NzbDrone.Core.Indexers.Rarbg
{
    ...
    public class RarbgSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(5, Type = FieldType.TagSelect, SelectOptions = typeof(IndexerFlags), Label = "Required Flags", HelpText = "What indexer flags are required?", HelpLink = "https://wiki.servarr.com/whisparr/settings#indexer-flags", Advanced = true)]
