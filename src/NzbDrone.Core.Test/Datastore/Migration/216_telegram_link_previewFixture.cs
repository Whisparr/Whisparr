...
namespace NzbDrone.Core.Test.Datastore.Migration
{
        ...
        public void should_set_link_preview_to_none_when_no_metadata_links()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("Notifications").Row(new
                {
                    ...
                    Tags = "[]",
                    Settings = new TelegramSettings215
                    {
                        BotToken = "secret",
                        ChatId = "12345",
                        SendSilently = false,
            ...
            var items = db.Query<NotificationDefinition216>("SELECT * FROM \"Notifications\"");
    ...
    public class NotificationDefinition216
    {
        public int Id { get; set; }
        public string Implementation { get; set; }
        public string ConfigContract { get; set; }
        public TelegramSettings216 Settings { get; set; }
    ...
    public class TelegramSettings215
    {
    ...
    public class TelegramSettings216
    {
        public string BotToken { get; set; }
        public string ChatId { get; set; }
        public int? TopicId { get; set; }
