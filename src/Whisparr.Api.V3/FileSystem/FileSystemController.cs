...
namespace Whisparr.Api.V3.FileSystem
{
    ...
    public class FileSystemController : Controller
    {
        ...
        [ProducesResponseType(typeof(FileSystemResult), 200)]
        ...
        public FileSystemTypeResource GetEntityType(string path)
        {
            ...
            {
                return new FileSystemTypeResource { Type = "file" };
            }

            // Return folder even if it doesn't exist on disk to avoid leaking anything from the UI about the underlying system
            return new FileSystemTypeResource { Type = "folder" };
        }
        ...
        public IEnumerable<FileSystemMediaFileResource> GetMediaFiles(string path)
        {
            ...
            {
                return Array.Empty<FileSystemMediaFileResource>();
            }
