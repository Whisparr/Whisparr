...
namespace NzbDrone.Core.Configuration
{
    ...
    public class ConfigFileProvider : IConfigFileProvider
    {
        ...
        public string PostgresMainDb => GetValue("PostgresMainDb", "whisparr-main", persist: false);
        public string PostgresLogDb => GetValue("PostgresLogDb", "whisparr-log", persist: false);
