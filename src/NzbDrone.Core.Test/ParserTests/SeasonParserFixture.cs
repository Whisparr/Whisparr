...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class SeasonParserFixture : CoreTest
    {
        ...
        [TestCase("Whisparr.and.Series.S02.720p.x264-DIMENSION", "Whisparr and Series", 2)]
        [TestCase("The.Series.US.S03.720p.x264-DIMENSION", "The Series US", 3)]
        [TestCase(@"Series.of.Whisparr.S03.720p.BluRay-CLUE\REWARD", "Series of Whisparr", 3)]
