...
namespace NzbDrone.Core.ImportLists.Simkl
{
    ...
    where TSettings : SimklSettingsBase<TSettings>, new()
    {
        ...
        public const string RedirectUri = "https://auth.servarr.com/v1/simkl_whisparr/auth";
        public const string RenewUri = "https://auth.servarr.com/v1/simkl_whisparr/renew";
