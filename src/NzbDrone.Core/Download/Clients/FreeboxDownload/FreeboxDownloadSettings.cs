...
namespace NzbDrone.Core.Download.Clients.FreeboxDownload
{
    ...
    public class FreeboxDownloadSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Whisparr avoids conflicts with unrelated non-Whisparr downloads (will create a [category] subdirectory in the output directory)")]
