...
namespace NzbDrone.Core.Extras.Metadata.Consumers.Xbmc
{
    ...
    public class XbmcMetadataSettings : IProviderConfig
    {
        ...
        [FieldDefinition(3, Label = "Episode Metadata Image Thumbs", Type = FieldType.Checkbox, Section = MetadataSectionType.Image, HelpText = "Include image thumb tags in <filename>.nfo (Requires 'Episode Metadata')", Advanced = true)]
