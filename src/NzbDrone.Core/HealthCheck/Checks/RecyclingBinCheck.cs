...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class RecyclingBinCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Error, $"Unable to write to configured recycling bin folder: {recycleBin}. Ensure this path exists and is writable by the user running Whisparr", "#cannot-write-recycle-bin");
            }
