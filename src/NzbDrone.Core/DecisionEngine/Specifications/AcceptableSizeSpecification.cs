    ...
    public class AcceptableSizeSpecification : IDecisionEngineSpecification
    {
        ...
        public Decision IsSatisfiedBy(RemoteMovie subject, SearchCriteriaBase searchCriteria)
        {
            ...
            if (qualityDefinition.MinSize.HasValue)
            {
                ...
                minSize = minSize * subject.Movie.MediaMetadata.Value.Runtime;
            ...
            else if (subject.Movie.MediaMetadata.Value.Runtime == 0)
            {
            ...
            else
            {
                ...
                //Multiply maxSize by Series.Runtime
                maxSize = maxSize * subject.Movie.MediaMetadata.Value.Runtime;
