...
namespace NzbDrone.Core.Download.Clients.Transmission
{
    ...
    public class TransmissionSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "PostImportCategory", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for {appName} to set after it has imported the download. {appName} will not remove torrents in that category even if seeding finished. Leave blank to keep same category.")]
