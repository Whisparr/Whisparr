...
import StudioIndexTableHeader from './StudioIndexTableHeader';
import styles from './StudioIndexTable.css';
...
const columnsSelector = createSelector(
  (state: AppState) => state.studios.columns,
  (columns) => columns
);
...
function StudioIndexTable(props: StudioIndexTableProps) {
  const {
    items,
    sortKey,
    sortDirection,
