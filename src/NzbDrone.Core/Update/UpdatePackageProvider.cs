...
namespace NzbDrone.Core.Update
{
    ...
    public class UpdatePackageProvider : IUpdatePackageProvider
    {
        ...
        public UpdatePackageProvider(IHttpClient httpClient, IWhisparrCloudRequestBuilder requestBuilder, IAnalyticsService analyticsService, IPlatformInfo platformInfo)
        {
