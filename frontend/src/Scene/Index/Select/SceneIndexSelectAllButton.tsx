...
interface SceneIndexSelectAllButtonProps {
  label: string;
  isSelectMode: boolean;
  overflowComponent: React.FunctionComponent<never>;
}

function SceneIndexSelectAllButton(props: SceneIndexSelectAllButtonProps) {
...
export default SceneIndexSelectAllButton;
