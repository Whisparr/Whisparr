...
namespace NzbDrone.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Whisparr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Whisparr terminating any other instances", StartupContext.TERMINATE);
