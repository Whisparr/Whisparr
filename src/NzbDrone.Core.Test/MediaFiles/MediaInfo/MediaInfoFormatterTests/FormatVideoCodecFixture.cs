...
namespace NzbDrone.Core.Test.MediaFiles.MediaInfo.MediaInfoFormatterTests
{
    ...
    public class FormatVideoCodecFixture : TestBase
    {
        ...
        [TestCase("vc1, WMV3", "Series Title S09E13 The Whisparr's RevengeHDTV.XviD-2HD.avi", "VC1")]
        ...
        [TestCase("hevc, V_MPEGH/ISO/HEVC", "Series the Title S11E12 The Whisparr Metric 1080p 10bit AMZN WEB-DL", "h265")]
        [TestCase("mpeg4, mp4v-20", "", "")]
        [TestCase("mpeg4, XVID", "Series the Title.S06E07.Mountain.Whisparr.DSR.XviD-KRS", "XviD")]
