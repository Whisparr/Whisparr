...
export const CLEAN_UNMAPPED_FILES = 'CleanUnmappedFiles';
...
export const REFRESH_PERFORMER = 'RefreshPerformers';
export const REFRESH_STUDIO = 'RefreshStudios';
export const RENAME_FILES = 'RenameFiles';
export const RENAME_MOVIE = 'RenameMovie';
export const RESCAN_SCENES = 'RescanScenes';
export const RESET_API_KEY = 'ResetApiKey';
export const RESET_QUALITY_DEFINITIONS = 'ResetQualityDefinitions';
export const RSS_SYNC = 'RssSync';
export const MOVIE_SEARCH = 'MoviesSearch';
export const STUDIO_SEARCH = 'StudiosSearch';
export const PERFORMER_SEARCH = 'PerformersSearch';
