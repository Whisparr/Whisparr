...
namespace NzbDrone.Core.Notifications.Ntfy
{
    ...
    public class NtfySettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "NotificationsNtfySettingsClickUrl", Type = FieldType.Url, HelpText = "NotificationsNtfySettingsClickUrlHelpText", Placeholder = "https://myserver.example.com/whisparr")]
