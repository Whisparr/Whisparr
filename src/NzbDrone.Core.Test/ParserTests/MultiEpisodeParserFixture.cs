...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class MultiEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Series's Whisparr - 8x01_02 - Free Falling", "Series's Whisparr", 8, new[] { 1, 2 })]
        ...
        [TestCase("World Series of Whisparr - 2010x15 - 2010x16 - HD TV.mkv", "World Series of Whisparr", 2010, new[] { 15, 16 })]
        ...
        // [TestCase("My Name Is Whisparr - S03E01-E02 - My Name Is Code 28301-016 [SDTV]", "My Name Is Whisparr", 3, new[] { 1, 2 })]
        // [TestCase("Adventure Series - 5x01 - x02 - Dev the Human (2) & Whisparr the Robot (3)", "Adventure Series", 5, new [] { 1, 2 })]
