                    ...
                    >
                      ...
                      >
                        ...
                        <FormInputGroup
                          ...
                          helpText="Hardlinks allow Whisparr to import seeding torrents to the the site folder without taking extra disk space or copying the entire contents of the file. Hardlinks will only work if the source and destination are on the same volume"
                          helpTextWarning="Occasionally, file locks may prevent renaming files that are being seeded. You may temporarily disable seeding and use Whisparr's rename function as a work around."
                          onChange={onInputChange}
                ...
                >
                  <FormGroup size={sizes.MEDIUM}>
                    ...
                    <FormInputGroup
                      ...
                      helpText="Episodes deleted from disk are automatically unmonitored in Whisparr"
                      onChange={onInputChange}
                  ...
                  >
                    ...
                    <FormInputGroup
                      ...
                      helpText="Extract video information such as resolution, runtime and codec information from files. This requires Whisparr to read parts of the file which may cause high disk or network activity during scans."
                      onChange={onInputChange}
                    ...
                    >
                      ...
                      >
                        ...
                        <FormInputGroup
                          ...
                          helpTextWarning="This only works if the user running whisparr is the owner of the file. It's better to ensure the download client sets the permissions properly."
                          onChange={onInputChange}
                      ...
                      >
                        ...
                        <FormInputGroup
                          ...
                          helpTextWarning="This only works if the user running whisparr is the owner of the file. It's better to ensure the download client uses the same group as whisparr."
                          values={fileDateOptions}
                          onChange={onInputChange}
                          {...settings.chownGroup}
                        />
