...
function getSelectedOption<V, T extends EnhancedSelectInputValue<V>>(
...
function findIndex<V, T extends EnhancedSelectInputValue<V>>(
...
function previousIndex<V, T extends EnhancedSelectInputValue<V>>(
  selectedIndex: number,
  values: T[]
) {
...
function nextIndex<V, T extends EnhancedSelectInputValue<V>>(
  selectedIndex: number,
  values: T[]
) {
  return findIndex(selectedIndex, 1, values);
...
function getSelectedIndex<V, T extends EnhancedSelectInputValue<V>>(
  value: V,
  values: T[]
) {
...
function isSelectedItem<V, T extends EnhancedSelectInputValue<V>>(
  index: number,
  value: V,
  values: T[]
) {
...
function EnhancedSelectInput<V, T extends EnhancedSelectInputValue<V>>(
