...
namespace NzbDrone.Core.Test.MediaFiles.EpisodeImport.Specifications
{
    ...
    public class MatchesFolderSpecificationFixture : CoreTest<MatchesFolderSpecification>
    {
        ...
        public void should_be_accepted_if_file_and_folder_have_the_same_episode()
        {
            ...
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01E01.720p.HDTV-Whisparr\S01E01.mkv".AsOsAgnostic();
        ...
        public void should_be_accepted_if_file_is_one_episode_in_folder()
        {
            _localEpisode.FileEpisodeInfo.EpisodeNumbers = new[] { 1 };
            _localEpisode.FolderEpisodeInfo.EpisodeNumbers = new[] { 1 };
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01E01E02.720p.HDTV-Whisparr\S01E01.mkv".AsOsAgnostic();
        ...
        public void should_disregard_subfolder()
        {
            ...
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01E01E02.720p.HDTV-Whisparr\S01E05E06.mkv".AsOsAgnostic();
        ...
        {
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01E01.720p.HDTV-Whisparr\S01E05.mkv".AsOsAgnostic();
        ...
        public void should_be_rejected_if_file_and_folder_do_not_have_episodes_from_the_same_season()
        {
            ...
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01.720p.HDTV-Whisparr\S02E01.mkv".AsOsAgnostic();
        ...
        public void should_be_accepted_if_file_and_folder_have_episodes_from_the_same_season()
        {
            ...
            _localEpisode.Path = @"C:\Test\Unsorted\Series.Title.S01.720p.HDTV-Whisparr\S01E01.mkv".AsOsAgnostic();
