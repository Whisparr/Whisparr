...
namespace NzbDrone.Core.Notifications.Stash
{
    ...
    public class StashSettings : IProviderConfig
    {
        ...
        [FieldDefinition(5, Label = "Map Paths From", Type = FieldType.Textbox, Advanced = true, HelpText = "Whisparr Path, Used to modify site paths when Stash sees library path location differently from Whisparr")]
        public string MapFrom { get; set; }

        [FieldDefinition(6, Label = "Map Paths To", Type = FieldType.Textbox, Advanced = true, HelpText = "Stash Path, Used to modify site paths when Stash sees library path location differently from Whisparr")]
