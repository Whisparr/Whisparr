...
namespace NzbDrone.Common.Instrumentation
{
    public static class NzbDroneLogger
    {
        ...
        private static void RegisterConsole()
        {
            ...
            var logFormat = Enum.TryParse<ConsoleLogFormat>(Environment.GetEnvironmentVariable("WHISPARR__LOG__CONSOLEFORMAT"), out var formatEnumValue)
                ? formatEnumValue
        ...
        private static void RegisterGlobalFilters()
        {
            LogManager.Setup().LoadConfiguration(c =>
            {
                ...
                c.ForLogger("Whisparr.Http.Authentication.ApiKeyAuthenticationHandler").WriteToNil(LogLevel.Info);
            });
        }
