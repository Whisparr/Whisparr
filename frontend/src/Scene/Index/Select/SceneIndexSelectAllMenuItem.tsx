...
interface SceneIndexSelectAllMenuItemProps {
  label: string;
  isSelectMode: boolean;
}

function SceneIndexSelectAllMenuItem(props: SceneIndexSelectAllMenuItemProps) {
...
export default SceneIndexSelectAllMenuItem;
