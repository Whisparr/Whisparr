...
class DeleteSceneModalContent extends Component {
  ...
  render() {
    ...
    if (!hasFile) {
      deleteFilesLabel = translate('DeleteSceneFolderLabel');
      deleteFilesHelpText = translate('DeleteSceneFolderHelpText');
    }
...
DeleteSceneModalContent.propTypes = {
