...
import SceneCreditPosterConnector from './SceneCreditPosterConnector';
import styles from './SceneCreditPosters.css';
...
const columnPadding = parseInt(dimensions.sceneIndexColumnPadding);
const columnPaddingSmallScreen = parseInt(dimensions.sceneIndexColumnPaddingSmallScreen);
...
class SceneCreditPosters extends Component {
...
SceneCreditPosters.propTypes = {
  items: PropTypes.arrayOf(PropTypes.object).isRequired,
  itemComponent: PropTypes.elementType.isRequired,
  isSmallScreen: PropTypes.bool.isRequired
};

export default SceneCreditPosters;
