...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class SingleEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase(@"24-7 Series - Title - Road to the Whisparr - S01E03 - Episode 3.mkv", "24-7 Series - Title - Road to the Whisparr", 1, 3)]
        ...
        [TestCase("24 7 Series-Title - Road to the Whisparr Part01 720p HDTV x264 ORENJI", "24 7 Series-Title - Road to the Whisparr", 1, 1)]
        [TestCase("24 7 Series-Title - Road to the Whisparr Part 02 720p HDTV x264 ORENJI", "24 7 Series-Title - Road to the Whisparr", 1, 2)]
        [TestCase("24-7 Series-Title - Road to the Whisparr - S01E01 - Part 1", "24-7 Series-Title - Road to the Whisparr", 1, 1)]
        ...
        [TestCase("App.Whisparr.Made.in.Canada.Part.Two.720p.HDTV.x264-2HD", "App Whisparr Made in Canada", 1, 2)]
        ...
        [TestCase("Series.Title.S01.Ep.01.English.AC3.DL.1080p.BluRay-Whisparr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.E.01.English.AC3.DL.1080p.BluRay-Whisparr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.Ep01.English.AC3.DL.1080p.BluRay-Whisparr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.E01.English.AC3.DL.1080p.BluRay-Whisparr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01EP01.English.AC3.DL.1080p.BluRay-Whisparr", "Series Title", 1, 1)]
