...
namespace NzbDrone.Core.Indexers.Nyaa
{
    ...
    public class NyaaSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(4, Type = FieldType.Select, SelectOptions = typeof(IndexerFlags), Label = "Required Flags", HelpText = "What indexer flags are required?", HelpLink = "https://wiki.servarr.com/whisparr/settings#indexer-flags", Advanced = true)]
