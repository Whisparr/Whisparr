...
namespace NzbDrone.Core.Download.Clients.Deluge
{
    ...
    public class DelugeSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for Whisparr to set after it has imported the download. Whisparr will not remove torrents in that category even if seeding finished. Leave blank to keep same category.")]
