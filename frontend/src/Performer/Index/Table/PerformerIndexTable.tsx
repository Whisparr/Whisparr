...
import PerformerIndexTableHeader from './PerformerIndexTableHeader';
import styles from './PerformerIndexTable.css';
...
const columnsSelector = createSelector(
  (state: AppState) => state.performers.columns,
  (columns) => columns
);
...
function PerformerIndexTable(props: PerformerIndexTableProps) {
  const {
    items,
    sortKey,
    sortDirection,
